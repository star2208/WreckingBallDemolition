...
public class TweenPPVWeight : SerializedMonoBehaviour
{
    ...
    private float OriginValue
    {
        get
        {
            if (originValueSetted == false)
            {
                ...
                {
                    originValue = postProcessVolume.weight;
                }
            }
            return originValue;
        }
    ...
    private void SetValue ( float value)
    {
        ...
        if (postProcessVolume)
        {
            if (relative) postProcessVolume.weight = value + OriginValue;
            else
            if ( multiplier) postProcessVolume.weight = value * OriginValue;
            else
            {
