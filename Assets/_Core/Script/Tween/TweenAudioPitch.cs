...
public class TweenAudioPitch : SerializedMonoBehaviour
{
    ...
    private void SetValue ( float value)
    {
        ...
        if (audioSource)
        {
            if (relative) audioSource.pitch = value + OriginValue;
            else
            if ( multiplier) audioSource.pitch = value * OriginValue;
            else
            {
