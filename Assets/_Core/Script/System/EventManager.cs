...
public class Events
{
    public static string GAME_STATE_CHANGED = "game_state_changed";             //当游戏状态改变

    public static string INPUT_POINTER_DOWN = "input_pointer_down";             //输入 当指针按下
    public static string INPUT_POINTER_UP = "input_pointer_up";                 //输入 当指针放开
    public static string INPUT_POINTER_MOVE = "input_pointer_move";             //输入 当指针移动
}
