...
//来自插件 Safe Area Helper 的
//限制 UI 范围在手机屏幕安全区域内, iOS 和 Android 都适用

//修改： 增加属性 refreshInUpdate
//当屏幕可以运行时横屏竖屏切换时需要在 Update 里 Refresh， 需要设为 true
//否则可以设为 false
...
{
    public bool refreshInUpdate = false;
